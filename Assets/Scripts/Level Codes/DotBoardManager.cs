...
public class DotBoardManager : MonoBehaviour
{
    ...
    private void startNewLine(Vector2Int startCell)
    {
        ...
        Vector3 startPos = new Vector3(startCell.x * cellSize, startCell.y * cellSize, -0.1f);
    ...
    {
        Vector3 endPos = new Vector3(endCell.x * cellSize, endCell.y * cellSize, -0.1f);
